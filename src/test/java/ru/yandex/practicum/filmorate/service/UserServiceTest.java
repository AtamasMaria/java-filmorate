...
class UserServiceTest {
    ...
    void shouldAddUserWhenValidUserData() {
        User user = new User(0,
                ...
                new ArrayList<>());
        User addedUser = service.create(user);
        assertNotEquals(0, addedUser.getId());
        assertTrue(service.findAll().contains(addedUser));
    }
    ...
    void shouldThrowExceptionWhenFailedUserLogin() {
        User user = new User(0,
                ...
                LocalDate.of(2002, 1, 1),
                new ArrayList<>());
        ValidationException ex = assertThrows(ValidationException.class, () -> service.create(user));
